 ...
 * @author ASUS
 */
public class JDlgMljfsCliente extends javax.swing.JDialog {
     ...
     */
    public JDlgMljfsCliente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgMljfsCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgMljfsCliente dialog = new JDlgMljfsCliente(new javax.swing.JFrame(), true);
