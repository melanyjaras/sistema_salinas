 ...
 * @author u10285656155
 */
public class JDlgMljfsFuncionariosNovo extends javax.swing.JDialog {

    private boolean incluindo = true;
JDlgMljfsFuncionariosNovoIA jDlgFuncionariosNovoIA = new JDlgMljfsFuncionariosNovoIA(null,true);
    private FuncionariosController funcionariosController = new FuncionariosController();
    //private JDlgMljfsFuncionariosNovoIA jDlgFuncionariosNovoIA;

    /**
     * Creates new form JDlgProdutosNovo
     */
    public JDlgMljfsFuncionariosNovo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgMljfsFuncionariosNovo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgMljfsFuncionariosNovo dialog = new JDlgMljfsFuncionariosNovo(new javax.swing.JFrame(), true);
