 ...
 * @author Melany
 */
public class JDlgMljfsFuncionariosNovoIA extends javax.swing.JDialog {
public FuncionariosController funcionariosController = new FuncionariosController();
       
    public JDlgMljfsFuncionariosNovoIA(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgMljfsFuncionariosNovoIA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgMljfsFuncionariosNovoIA dialog = new JDlgMljfsFuncionariosNovoIA(new javax.swing.JFrame(), true);
