 ...
 * @author ASUS
 */
public class JFrmMljfsLogin extends javax.swing.JFrame {

    /**
     * Creates new form JFrmLogin
     */
    public JFrmMljfsLogin() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Usuário (sobrenome)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrmMljfsLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new JFrmMljfsLogin().setVisible(true);
            }
        });
    }
